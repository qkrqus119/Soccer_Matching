  ...
  <div id="demo" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner">
      ...
      <div class="carousel-item active">
        <img src="resources/img/soccer01.jpg" alt="soccer01" width="100%" height="100vh">
      </div>
      <div class="carousel-item">
        <img src="resources/img/soccer02.jpg" alt="soccer02" width="100%" height="100vh">
      </div>
      <div class="carousel-item">
        <img src="resources/img/soccer03.jpg" alt="soccer03" width="100%" height="100vh">
      </div>
      <div class="welcome-section content-hidden" onclick="window.location.href='background.html'" style="cursor:pointer">
